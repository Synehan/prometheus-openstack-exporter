...
class HeatServiceStats(OSBase):
    """ Class to report the statistics on Heat services.
    ...
    def build_cache_data(self):
        ...
        stats = self.osclient.get_workers('heat')
        for worker in stats:
    ...
    def get_stats(self):
        ...
        for services_stat in services_stats_cache:
            stat_gauge = Gauge(
                ...
                'Openstack Heat Service statistic',
                labels,
                registry=registry)
